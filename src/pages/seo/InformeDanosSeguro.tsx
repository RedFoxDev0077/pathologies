...
const DEFAULT = {
  ...
  seo: { title: 'Informe de Daños para Reclamar al Seguro del Hogar | Mi Casa Verde', description: '¿El seguro te pide un informe de daños? Obtenlo en 24-48h desde 400€ + IVA. Válido para reclamar humedades, grietas o filtraciones ante tu aseguradora. Firmado por arquitecto colegiado.', og_title: 'Informe de Daños para Reclamar al Seguro del Hogar · Mi Casa Verde', og_description: 'Informe técnico de daños válido para reclamar al seguro. Firmado por arquitecto colegiado. Desde 400€ + IVA, entrega en 24-48h.', og_image_url: '' },
};
