...
const DEFAULT = {
  ...
  seo: { title: 'Informe Técnico de Grietas Estructurales · ¿Es peligrosa tu grieta? | Mi Casa Verde', description: '¿Tienes grietas en la pared y no sabes si son peligrosas? Informe técnico de grietas estructurales firmado por arquitecto colegiado. Desde 400€ + IVA, entrega en 24-48h.', og_title: 'Informe Técnico de Grietas Estructurales · Mi Casa Verde', og_description: '¿Es peligrosa tu grieta? Informe técnico firmado por arquitecto colegiado. Desde 400€ + IVA, entrega en 24-48h.', og_image_url: '' },
};
