...
const DEFAULT_CONTENT: Record<string, PageContent> = {
  ...
  landing_grietas: {
    ...
    faq: { section_title: 'Preguntas frecuentes sobre grietas en viviendas', faqs: [{ q: '¿Es grave una grieta en la pared?', a: 'No todas las grietas son peligrosas. Las fisuras finas en yeso son habitualmente superficiales. Las grietas horizontales en elementos portantes sí pueden indicar riesgo estructural.' }, { q: '¿Cómo saber si una grieta es estructural?', a: 'Una grieta puede ser estructural si supera 5 mm de anchura, es diagonal en esquinas de huecos, aparece en pilares o vigas, o si crece con el tiempo.' }, { q: '¿Qué hace el técnico al revisar una grieta?', a: 'Analiza la dirección, anchura y profundidad; la localización en el elemento constructivo; la causa probable y su evolución.' }, { q: '¿Cuánto cuesta el informe de grietas?', a: 'El análisis técnico orientativo con nuestro asistente es gratuito. El Informe Técnico Online cuesta 400€ + IVA e incluye el análisis completo de fotos y vídeos, una consulta telefónica con el arquitecto y el informe PDF firmado, con entrega en 24-48 horas. Si el caso requiere inspección presencial in situ, el Informe Pericial Presencial es de 950€ + IVA.' }, { q: '¿Sirve para reclamar al seguro?', a: 'Sí. Si las grietas son consecuencia de un siniestro cubierto, el informe técnico acredita el daño y su origen.' }] },
    cta: { h2: '¿Tienes grietas y quieres saber si son peligrosas?', subtitle: 'Empieza con el análisis gratuito. Solo necesitas fotos de las grietas.', btn_text: 'Analizar mis grietas →', subnote: 'Análisis gratuito · Informe desde 400€ + IVA · Entrega 24-48h' },
    seo: { title: 'Informe Técnico de Grietas Estructurales · ¿Es peligrosa tu grieta? | Mi Casa Verde', description: '¿Tienes grietas en la pared y no sabes si son peligrosas? Informe técnico de grietas estructurales con revisión de técnico cualificado. Desde 400€ + IVA, entrega en 24-48h.', og_title: 'Informe Técnico de Grietas Estructurales · Mi Casa Verde', og_description: '¿Es peligrosa tu grieta? Informe técnico con revisión de técnico cualificado. Desde 400€ + IVA, entrega en 24-48h.', og_image_url: '' },
  },
  landing_danos: {
    ...
    cta: { h2: '¿Necesitas el informe para reclamar al seguro?', subtitle: 'Empieza ahora. Solo necesitas fotos del daño y la descripción del problema.', btn_text: 'Solicitar informe para el seguro →', subnote: 'Análisis gratuito · Informe desde 400€ + IVA · Entrega 24-48h' },
    seo: { title: 'Informe de Daños para Reclamar al Seguro del Hogar | Mi Casa Verde', description: '¿El seguro te pide un informe de daños? Obtenlo en 24-48h desde 400€ + IVA. Válido para reclamar humedades, grietas o filtraciones ante tu aseguradora. Revisado por técnico cualificado.', og_title: 'Informe de Daños para Reclamar al Seguro del Hogar · Mi Casa Verde', og_description: 'Informe técnico de daños válido para reclamar al seguro. Revisado por técnico cualificado. Desde 400€ + IVA, entrega en 24-48h.', og_image_url: '' },
  },
  landing_comunidad: {
    ...
    faq: { section_title: 'Preguntas frecuentes sobre reclamaciones a la comunidad', faqs: [{ q: '¿Quién paga las humedades del vecino de arriba?', a: 'Si la filtración proviene de la vivienda del vecino, paga él o su seguro. Si proviene de elementos comunes (cubierta, bajantes), paga la comunidad.' }, { q: '¿Qué documento necesito para reclamar al vecino?', a: 'Un informe técnico pericial que acredite que el origen de la filtración está en su vivienda.' }, { q: '¿Puede la comunidad negarse a reparar las humedades?', a: 'La comunidad tiene obligación legal de mantener los elementos comunes. Si se niega, puedes reclamar formalmente con el informe técnico.' }, { q: '¿Cuánto cuesta un informe para la comunidad?', a: 'El análisis técnico orientativo con nuestro asistente es gratuito. El Informe Técnico Online cuesta 400€ + IVA e incluye el análisis completo de fotos y vídeos, una consulta telefónica con el arquitecto y el informe PDF firmado, con entrega en 24-48 horas. Si el caso requiere inspección presencial in situ, el Informe Pericial Presencial es de 950€ + IVA.' }, { q: '¿Qué hago si el presidente de la comunidad no actúa?', a: 'Envía un burofax formal con el informe técnico adjunto. Si no hay respuesta, convoca junta extraordinaria o acude al juzgado.' }] },
    cta: { h2: '¿Necesitas el informe para reclamar al vecino o a la comunidad?', subtitle: 'Empieza ahora. Solo necesitas fotos de las humedades y la descripción del problema.', btn_text: 'Obtener informe para reclamar →', subnote: 'Análisis gratuito · Informe desde 400€ + IVA · Entrega 24-48h' },
    seo: { title: 'Informe Técnico para Comunidad de Propietarios · Humedades y Filtraciones | Mi Casa Verde', description: '¿Humedades del vecino de arriba o de elementos comunes? Informe técnico para reclamar a la comunidad de propietarios o al vecino. Desde 400€ + IVA, entrega en 24-48h.', og_title: 'Informe para Comunidad de Propietarios · Mi Casa Verde', og_description: 'Informe técnico para reclamar humedades al vecino o a la comunidad. Desde 400€ + IVA, revisado por técnico cualificado, entrega en 24-48h.', og_image_url: '' },
  },
};
